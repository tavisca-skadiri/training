...
class MerchantGalaxyTest {
    ...
    void checkQuestionParser(){
        ...
        StatementParser statementParser = new StatementParser();
        HashMap<String, Double> unknownWords = statementParser.setUnknownItemAndCredit(input2,words);

        ArrayList<String> input3 = new ArrayList<>();
        input3.add("how much is pish tegj glob glob ?");

        QuestionParser questionParser = new QuestionParser();
        assertEquals(42,questionParser.getHowMuchValue(input3,words,unknownWords));
    }
